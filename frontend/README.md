...
- `docs/Frontend-technology-contract.md` — канонический стек React + TypeScript + Electron + Vite + Fluent UI и строгие typed boundaries Python Backend / AudioService / Electron.
