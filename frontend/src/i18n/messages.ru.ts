...
export const ru: MessageTable = {
  ...
  aiProcessingBackend: "Где обрабатывать песни",
  aiBackendLocal: "Этот компьютер (NVIDIA/CPU)",
  aiBackendKaggle: "Kaggle GPU (для слабого ПК)",
  aiBackendSaved: "Режим обработки сохранён",
  kaggleUrl: "Адрес ноутбука Kaggle",
  kaggleToken: "Секретный токен",
  kaggleTokenSaved: "Токен уже сохранён. Оставьте поле пустым, чтобы не менять его.",
  kaggleTokenRequired: "Введите AD_VOICE_TOKEN, заданный в ноутбуке.",
