...
export const uk: MessageTable = {
  ...
  mixerMicrophone: "Мікрофон",
  mixerGuide: "Гід-вокал",
  ...
  modeLyricsPiano: "Текст + Piano Roll",
  modeLyricsOnly: "Лише текст",
  modeLyricsPitch: "Текст + Live Pitch",
  modeMinimal: "Мінімальна сцена",
