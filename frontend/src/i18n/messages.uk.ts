...
export const uk: MessageTable = {
  ...
  aiProcessingBackend: "Де обробляти пісні",
  aiBackendLocal: "Цей комп'ютер (NVIDIA/CPU)",
  aiBackendKaggle: "Kaggle GPU (для слабкого ПК)",
  aiBackendSaved: "Режим обробки збережено",
  kaggleUrl: "Адреса ноутбука Kaggle",
  kaggleToken: "Секретний токен",
  kaggleTokenSaved: "Токен уже збережено. Залиште поле порожнім, щоб не змінювати його.",
  kaggleTokenRequired: "Введіть AD_VOICE_TOKEN, заданий у ноутбуці.",
  ...
  host: "Організатор",
  language: "Мова",
  keyboardLighting: "Підсвічування клавіатури",
  keyboardLightingStatus: "{provider} · клавіатур: {count}",
  enabled: "Увімкнено",
  lightingMode: "Режим підсвічування",
  lightingThemeMode: "Тема",
  lightingMusicMode: "Музика",
  lightingBrightness: "Яскравість",
  ...
  cancelTransfer: "Скасувати завантаження", retryTransfer: "Повторити завантаження",
  participantEffects: "Ефекти: {name}", participantReverb: "Реверберація", participantEcho: "Луна", participantDelay: "Затримка", participantNoiseSuppression: "Шумозаглушення", participantOctave: "Октава",
  pause: "Пауза",
  ...
  sorting: "Сортування",
  filtersApplyInstantly: "Зміни застосовуються одразу",
  sortAscending: "За зростанням",
  sortDescending: "За спаданням",
  sortDuration: "Тривалість",
  sortBpm: "Темп BPM",
  titleSort: "Назва",
  artistSort: "Виконавець",
  allLanguages: "Усі мови",
  languageAuto: "Визначати автоматично",
  languageUkrainian: "Українська",
  languageRussian: "Російська",
  languageEnglish: "Англійська",
  durationFilter: "Тривалість",
  durationAll: "Будь-яка тривалість",
  durationShort: "До 3 хвилин",
  durationMedium: "3–5 хвилин",
  durationLong: "Понад 5 хвилин",
  artworkFilter: "Обкладинка",
  artworkAll: "Будь-яка обкладинка",
  ...
  importing: "Імпорт",
  cancelImport: "Скасувати імпорт", importCancelled: "Імпорт скасовано",
  ...
  roomReconnecting: "Відновлення зв’язку з кімнатою…",
  ...
  transferHostAction: "Зробити {name} хостом",
  closeRoom: "Закрити кімнату",
  removeParticipant: "Виключити {name}",
  removeParticipantTitle: "Виключити учасника?",
  removeParticipantBody: "{name} залишить кімнату й зможе повернутися лише після повторного входу.",
  removedFromRoom: "Вас виключили з кімнати.",
  ...
  detectedTempo: "Визначений темп: {value}",
  detectedKey: "Визначена тональність: {value}",
  useDetectedValue: "Використати визначене значення",
  removeCustomCover: "Видалити власну обкладинку",
  recordingFileReady: "Файл готовий",
  recordingRecoveredIncomplete: "Відновлено / не завершено",
  recordingFileMissing: "Файл відсутній",
  recordingFileFailed: "Помилка файлу",
  analysisNotAnalyzed: "Не проаналізовано",
  analysisQueued: "Аналіз у черзі",
  analysisRunning: "Виконується аналіз",
