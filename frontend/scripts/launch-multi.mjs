...
const profiles = [
  ...
  { name: "AD Voice Dev", endpoint: String.raw`\\.\pipe\ADVoice.AudioService.Dev.v1`, debugPort: "9341" },
  { name: "AD Voice Multi 2", endpoint: String.raw`\\.\pipe\ADVoice.AudioService.Multi2.v1`, debugPort: "9342" },
];
